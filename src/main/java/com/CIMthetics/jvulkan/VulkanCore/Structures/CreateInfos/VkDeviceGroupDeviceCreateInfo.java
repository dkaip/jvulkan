...
public class VkDeviceGroupDeviceCreateInfo extends VulkanCreateInfoStructure
{
    Collection<VkPhysicalDevice> physicalDevices;
    
    public VkDeviceGroupDeviceCreateInfo()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO);
    }
