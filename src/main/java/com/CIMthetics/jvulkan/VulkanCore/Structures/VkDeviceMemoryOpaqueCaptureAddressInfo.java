...
public class VkDeviceMemoryOpaqueCaptureAddressInfo extends VulkanCreateInfoStructure
{
    private VkDeviceMemory  memory;
    
    public VkDeviceMemoryOpaqueCaptureAddressInfo()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO);
    }
