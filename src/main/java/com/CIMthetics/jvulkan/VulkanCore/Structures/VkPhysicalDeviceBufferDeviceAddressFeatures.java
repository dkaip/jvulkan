...
public class VkPhysicalDeviceBufferDeviceAddressFeatures extends VulkanCreateInfoStructure
{
    ...
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES);
    }
