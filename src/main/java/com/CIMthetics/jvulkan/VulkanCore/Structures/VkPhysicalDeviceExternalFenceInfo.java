...
public class VkPhysicalDeviceExternalFenceInfo extends VulkanCreateInfoStructure
{
    private VkExternalFenceHandleTypeFlagBits    handleType;
    
    public VkPhysicalDeviceExternalFenceInfo()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FENCE_INFO);
    }
