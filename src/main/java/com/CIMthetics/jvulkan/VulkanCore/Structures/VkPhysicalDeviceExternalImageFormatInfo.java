...
public class VkPhysicalDeviceExternalImageFormatInfo extends VulkanCreateInfoStructure
{
    private VkExternalMemoryHandleTypeFlagBits  handleType;

    public VkPhysicalDeviceExternalImageFormatInfo()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO);
    }
