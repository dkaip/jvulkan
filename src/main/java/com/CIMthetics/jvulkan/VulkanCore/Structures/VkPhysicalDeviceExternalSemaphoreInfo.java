...
public class VkPhysicalDeviceExternalSemaphoreInfo extends VulkanCreateInfoStructure
{
    private VkExternalSemaphoreHandleTypeFlagBits    handleType;
    
    public VkPhysicalDeviceExternalSemaphoreInfo()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO);
    }
