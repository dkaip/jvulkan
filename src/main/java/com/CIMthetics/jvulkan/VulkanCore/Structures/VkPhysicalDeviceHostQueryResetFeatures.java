...
public class VkPhysicalDeviceHostQueryResetFeatures extends VulkanCreateInfoStructure
{
    private boolean hostQueryReset;

    public VkPhysicalDeviceHostQueryResetFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES);
    }
