...
public class VkPhysicalDeviceImagelessFramebufferFeatures extends VulkanCreateInfoStructure
{
    private boolean imagelessFramebuffer;
    
    public VkPhysicalDeviceImagelessFramebufferFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES);
    }
