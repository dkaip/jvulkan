...
public class VkPhysicalDeviceProtectedMemoryFeatures extends VulkanCreateInfoStructure
{
    private boolean           protectedMemory;

    public VkPhysicalDeviceProtectedMemoryFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES);
    }
