...
public class VkPhysicalDeviceSamplerFilterMinmaxProperties extends VulkanCreateInfoStructure
{
    ...
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES);
    }
