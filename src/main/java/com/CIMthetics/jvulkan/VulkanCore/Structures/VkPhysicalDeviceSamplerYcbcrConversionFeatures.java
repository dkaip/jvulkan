...
public class VkPhysicalDeviceSamplerYcbcrConversionFeatures extends VulkanCreateInfoStructure
{
    private boolean samplerYcbcrConversion;

    public VkPhysicalDeviceSamplerYcbcrConversionFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES);
    }
