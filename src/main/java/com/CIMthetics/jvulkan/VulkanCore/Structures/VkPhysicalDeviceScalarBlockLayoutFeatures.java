...
public class VkPhysicalDeviceScalarBlockLayoutFeatures extends VulkanCreateInfoStructure
{
    private boolean scalarBlockLayout;

    public VkPhysicalDeviceScalarBlockLayoutFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES);
    }
