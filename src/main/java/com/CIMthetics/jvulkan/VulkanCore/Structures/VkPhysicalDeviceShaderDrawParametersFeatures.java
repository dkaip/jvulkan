...
public class VkPhysicalDeviceShaderDrawParametersFeatures extends VulkanCreateInfoStructure
{
    private boolean shaderDrawParameters;

    public VkPhysicalDeviceShaderDrawParametersFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETERS_FEATURES);
    }
