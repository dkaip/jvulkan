...
public class VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures extends VulkanCreateInfoStructure
{
    private boolean shaderSubgroupExtendedTypes;
    
    public VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES);
    }
