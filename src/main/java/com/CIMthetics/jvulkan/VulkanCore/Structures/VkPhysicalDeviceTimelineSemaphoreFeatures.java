...
public class VkPhysicalDeviceTimelineSemaphoreFeatures extends VulkanCreateInfoStructure
{
    private boolean timelineSemaphore;
    
    public VkPhysicalDeviceTimelineSemaphoreFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES);
    }
