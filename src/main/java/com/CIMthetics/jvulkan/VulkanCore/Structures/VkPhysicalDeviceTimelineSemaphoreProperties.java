...
public class VkPhysicalDeviceTimelineSemaphoreProperties extends VulkanCreateInfoStructure
{
    private long maxTimelineSemaphoreValueDifference;
    
    public VkPhysicalDeviceTimelineSemaphoreProperties()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES);
    }
