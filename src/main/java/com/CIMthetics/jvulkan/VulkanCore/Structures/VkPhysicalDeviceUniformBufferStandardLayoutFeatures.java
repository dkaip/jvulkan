...
public class VkPhysicalDeviceUniformBufferStandardLayoutFeatures extends VulkanCreateInfoStructure
{
    private boolean uniformBufferStandardLayout;
    
    public VkPhysicalDeviceUniformBufferStandardLayoutFeatures()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES);
    }
