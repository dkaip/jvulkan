...
public class VkPhysicalDeviceVariablePointersFeatures extends VulkanCreateInfoStructure
{
    ...
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES);
    }
    ...
    public void setVariablePointersStorageBuffer(
