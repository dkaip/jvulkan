...
public class VkRenderPassAttachmentBeginInfo extends VulkanCreateInfoStructure
{
    private Collection<VkImageView> attachments;
    
    public VkRenderPassAttachmentBeginInfo()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO);
    }
