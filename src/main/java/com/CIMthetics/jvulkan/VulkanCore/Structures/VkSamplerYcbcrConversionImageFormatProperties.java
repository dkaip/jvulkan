...
public class VkSamplerYcbcrConversionImageFormatProperties extends VulkanCreateInfoStructure
{
    private int combinedImageSamplerDescriptorCount;

    public VkSamplerYcbcrConversionImageFormatProperties()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES);
    }

    public int getCombinedImageSamplerDescriptorCount()
    {
