...
import com.CIMthetics.jvulkan.VulkanCore.VK11.Enums.VkPointClippingBehavior;
import com.CIMthetics.jvulkan.VulkanCore.VK11.Enums.VkStructureType;
import com.CIMthetics.jvulkan.VulkanCore.VK11.Structures.CreateInfos.VulkanCreateInfoStructure;

public class VkPhysicalDevicePointClippingProperties extends VulkanCreateInfoStructure
{
    private VkPointClippingBehavior pointClippingBehavior;
    
    public VkPhysicalDevicePointClippingProperties()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES);
    }
    ...
    public String toString()
    {
        ...
        sb.append(String.format("    pointClippingBehavior:%s\n", pointClippingBehavior.toString()));
