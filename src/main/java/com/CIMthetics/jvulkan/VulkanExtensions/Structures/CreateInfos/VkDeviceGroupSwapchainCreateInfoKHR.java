...
public class VkDeviceGroupSwapchainCreateInfoKHR extends VulkanCreateInfoStructure
{
    private EnumSet<VkDeviceGroupPresentModeFlagBitsKHR>    modes;

    public VkDeviceGroupSwapchainCreateInfoKHR()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_DEVICE_GROUP_SWAPCHAIN_CREATE_INFO_KHR);
    }
