...
public class VkCmdReserveSpaceForCommandsInfoNVX extends VulkanCreateInfoStructure
{
    ...
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_CMD_RESERVE_SPACE_FOR_COMMANDS_INFO_NVX);
    }
