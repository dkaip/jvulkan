...
public class VkImageViewAddressPropertiesNVX extends VulkanCreateInfoStructure
{
    ...
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_IMAGE_VIEW_ADDRESS_PROPERTIES_NVX);
    }
