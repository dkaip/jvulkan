...
public class VkPhysicalDeviceImagelessFramebufferFeaturesKHR extends VulkanCreateInfoStructure
{
    private boolean imagelessFramebuffer;
    
    public VkPhysicalDeviceImagelessFramebufferFeaturesKHR()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES_KHR);
    }
