...
public class VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT extends VulkanCreateInfoStructure
{
    private boolean shaderDemoteToHelperInvocation;

    public VkPhysicalDeviceShaderDemoteToHelperInvocationFeaturesEXT()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES_EXT);
    }
    ...
    public void setShaderDemoteToHelperInvocation(
