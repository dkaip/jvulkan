...
public class VkPhysicalDeviceTimelineSemaphoreFeaturesKHR extends VulkanCreateInfoStructure
{
    private boolean timelineSemaphore;
    
    public VkPhysicalDeviceTimelineSemaphoreFeaturesKHR()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR);
    }
