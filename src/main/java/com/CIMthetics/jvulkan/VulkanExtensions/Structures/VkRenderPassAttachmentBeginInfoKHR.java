...
public class VkRenderPassAttachmentBeginInfoKHR extends VulkanCreateInfoStructure
{
    private Collection<VkImageView> attachments;
    
    public VkRenderPassAttachmentBeginInfoKHR()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO_KHR);
    }
