...
public class VkTimelineSemaphoreSubmitInfoKHR extends VulkanCreateInfoStructure
{
    ...
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR);
    }
    ...
    public long[] getSignalSemaphoreValues()
    {
        return signalSemaphoreValues;
    }

    public void setSignalSemaphoreValues(long[] signalSemaphoreValues)
    {
