...
import com.CIMthetics.jvulkan.VulkanCore.VK11.Enums.VkSemaphoreImportFlagBits;
import com.CIMthetics.jvulkan.VulkanCore.VK11.Enums.VkStructureType;
import com.CIMthetics.jvulkan.VulkanCore.VK11.Handles.VkSemaphore;
import com.CIMthetics.jvulkan.VulkanCore.VK11.Structures.CreateInfos.VulkanCreateInfoStructure;

public class VkImportSemaphoreFdInfoKHR extends VulkanCreateInfoStructure
{
    private VkSemaphore                             semaphore;
    private EnumSet<VkSemaphoreImportFlagBits>      flags = EnumSet.noneOf(VkSemaphoreImportFlagBits.class);
    private VkExternalSemaphoreHandleTypeFlagBits   handleType;
    private int                                     fd;

    public VkImportSemaphoreFdInfoKHR()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHR);
    }
    ...
    public EnumSet<VkSemaphoreImportFlagBits> getFlags()
    {
        return flags;
    }

    public void setFlags(EnumSet<VkSemaphoreImportFlagBits> flags)
    {
        this.flags = flags;
    }
