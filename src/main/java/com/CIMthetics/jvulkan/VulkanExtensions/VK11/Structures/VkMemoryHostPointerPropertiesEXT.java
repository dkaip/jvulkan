...
public class VkMemoryHostPointerPropertiesEXT extends VulkanCreateInfoStructure
{
    private int memoryTypeBits;
    
    public VkMemoryHostPointerPropertiesEXT()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_MEMORY_HOST_POINTER_PROPERTIES_EXT);
    }
