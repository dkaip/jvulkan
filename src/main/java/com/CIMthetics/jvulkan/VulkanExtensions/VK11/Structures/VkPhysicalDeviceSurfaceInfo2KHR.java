...
public class VkPhysicalDeviceSurfaceInfo2KHR extends VulkanCreateInfoStructure
{
    private VkSurfaceKHR    surface;

    public VkPhysicalDeviceSurfaceInfo2KHR()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SURFACE_INFO_2_KHR);
    }
