...
public class VkPhysicalDeviceTimelineSemaphorePropertiesKHR extends VulkanCreateInfoStructure
{
    private long maxTimelineSemaphoreValueDifference;
    
    public VkPhysicalDeviceTimelineSemaphorePropertiesKHR()
    {
        super(VkStructureType.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR);
    }
    ...
    public void setMaxTimelineSemaphoreValueDifference(
